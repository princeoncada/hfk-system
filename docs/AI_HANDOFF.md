...
records only Ã¢â‚¬â€ the actual files live on disk and are never embedded.
...
## Patch 3.6.4 [3.6.4-stable] Ã¢â‚¬â€ Daily Review UX Polish + Print/Export Fixes
...
## Patch 3.6.3 [3.6.3-stable] Ã¢â‚¬â€ Final Package Lock and Worksheet Link
...
## Patch 3.6.2 [3.6.2-stable] Ã¢â‚¬â€ Daily Review UI/UX Fixes
...
## Patch 3.6.1 [3.6.1-stable] Ã¢â‚¬â€ Daily Review UI Improvements
...
## Phase 3.6.0 [3.6.0-stable] Ã¢â‚¬â€ Instructions Flow
...
## Patch 3.5.6 [3.5.6-stable] Ã¢â‚¬â€ Generate Caption Crash Fix
...
## Patch 3.5.5 [3.5.5-stable] Ã¢â‚¬â€ Mojibake + Missed Version Label Fix
...
## Patch 3.5.4 [3.5.4-stable] Ã¢â‚¬â€ Version Ordering Fix

Status: stable

Version: 3.5.4-stable

Scope: Docs hardening Ã¢â‚¬â€ version ordering fix and ordering rule.
...
## Patch 3.5.3 [3.5.3-stable] Ã¢â‚¬â€ 1-by-1 Commit Rule Hardening

Status: stable

Version: 3.5.3-stable

Scope: Docs hardening Ã¢â‚¬â€ one git add + one git commit per file rule.
...
## Patch 3.5.2 [3.5.2-stable] Ã¢â‚¬â€ Post-Stable Bug Versioning Rule
...
## Patch 3.5.1 [3.5.1-stable] Ã¢â‚¬â€ Generate Worksheet Crash Fix

Status: stable

Version: 3.5.1-stable

Scope: Bug fix Ã¢â‚¬â€ ReviewFlow.tsx handleGenerate.
...
## Patch 3.5.0 [3.5.0-stable] Ã¢â‚¬â€ Daily Review Fix

Status: stable

Version: 3.5.0-stable

Purpose: Daily Review Fix Ã¢â‚¬â€ Direction pre-populated from today's Planner data.
...
## Patch 3.3.1 [3.3.1-stable] Ã¢â‚¬â€ Export Overhaul

Status: stable

Version: 3.3.1-stable

Purpose: Export Overhaul Ã¢â‚¬â€ remove PDF export from preview and replace
...
## Phase 3.3.0 [3.3.0-stable] Ã¢â‚¬â€ Worksheet Builder
...
Purpose: Analytics + Recommendations Ã¢â‚¬â€ operator-facing analytics screen
using demo data until real performance metrics exist.

Scope:
- /analytics route Ã¢â‚¬â€ Server Component loads mock analytics snapshot
- AnalyticsDashboard client component Ã¢â‚¬â€ AI summary, top/worst post cards,
  subject-grade heatmap, localStorage-backed dismissible recommendations
- analytics types and mock snapshot provider
- SidebarNav Ã¢â‚¬â€ Analytics link added
...
## Phase 3.3.0 [3.3.0-stable] Ã¢â‚¬â€ UI Animations + Onboarding

Status: stable

Version: 3.3.0-stable

Purpose: UI Animations + Onboarding Ã¢â‚¬â€ first-run orientation, re-openable
...
Purpose: Vault Browser Ã¢â‚¬â€ standing UI for browsing, inspecting, and mutating
the lifecycle of Vault assets indexed in ChromaDB.

Scope:
- /vault route Ã¢â‚¬â€ Server Component loads all 7 asset types
- VaultBrowser client component Ã¢â‚¬â€ tabs, search, asset grid, lifecycle actions
- POST /api/vault/asset/[id]/lifecycle Ã¢â‚¬â€ lifecycle mutation via re-ingest
- SidebarNav Ã¢â‚¬â€ Vault link added
...
Scope:
- src/lib/calendar.ts (new) Ã¢â‚¬â€ getPackagesForMonth() read-only helper
- src/app/planner/[month]/page.tsx Ã¢â‚¬â€ load packages, pass to PlannerView
- src/components/planner/PlannerView.tsx Ã¢â‚¬â€ bi-directional rendering,
...
Scope:
- tailwind.config.ts Ã¢â‚¬â€ design tokens + font families
- globals.css Ã¢â‚¬â€ CSS custom properties
- layout.tsx Ã¢â‚¬â€ sidebar shell with SidebarNav client component
- SidebarNav.tsx (new) Ã¢â‚¬â€ active-state nav with usePathname
- page.tsx Ã¢â‚¬â€ Command Center redesign
- TodayStatus.tsx Ã¢â‚¬â€ dark banner card
- MonthProgress.tsx Ã¢â‚¬â€ card redesign
- VaultAlerts.tsx Ã¢â‚¬â€ tinted card redesign
- review/page.tsx Ã¢â‚¬â€ page heading
- planner/[month]/page.tsx Ã¢â‚¬â€ page heading + month nav
- ReviewFlow.tsx Ã¢â‚¬â€ design system applied
- PlannerView.tsx Ã¢â‚¬â€ design system applied
...
Direction Ã¢â€ â€™ Worksheet Ã¢â€ â€™ Template Ã¢â€ â€™ Caption Ã¢â€ â€™ Final Package. Persist package
