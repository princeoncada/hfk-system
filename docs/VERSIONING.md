...
| --- | --- | --- | --- | --- |
| 3.2.0-alpha | Phase 3.2.0 — Analytics + Recommendations | alpha | 2026-05-22 | Analytics + Recommendations — /analytics screen with AI-narrated demo summary, top/worst post lists, subject-grade heatmap, dismissible recommendation cards, and Analytics nav link added to sidebar. |
...
Current working version: 3.2.0-alpha
