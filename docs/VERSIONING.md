...
| --- | --- | --- | --- | --- |
| 3.0.0-alpha | Phase 3.0.0 — Calendar Intelligence | alpha | 2026-05-22 | Calendar Intelligence — bi-directional planner. Past cells show shipped/in-review status from package data. Future cells show plan + in-review state. Day detail panel includes gate-by-gate package summary. |
...
Current working version: 3.0.0-alpha
