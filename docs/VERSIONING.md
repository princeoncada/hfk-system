...
| State | alpha |
| Date | 2026-05-24 |
| Summary | Phase 4.4.0 — Live Preview + Publish: right-panel Style/Preview toggle with scaled DynamicWorksheetTemplate live preview driven by current TemplateDefinition state and sample worksheet content. |
...
Current stable version: 4.3.0-stable
Current working version: 4.4.0-alpha
Next recommended phase: Phase 4.5.0 — Vault Ingestion + AI Template Recommendation
