...
| --- | --- | --- | --- | --- |
| 3.6.3-alpha | Patch 3.6.3 — Final Package Lock and Worksheet Link | alpha | 2026-05-24 | Save AI worksheet to content/worksheets/ on final approval, show Edit Worksheet and Preview links in final gate, lock all action rows when package is complete, locked banner at page top. |
...
Current working version: 3.6.3-alpha
